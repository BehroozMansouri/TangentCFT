...
def tangent_to_fasttext(tangent_tuple_filepath, fasttext_tuple_filepath, ignore_frp=True, tokenize_all=False,
    ...
    tangent_to_fasttext("tangent-source","fasttext-destination",ignore_frp=False, tokenize_all=True, tokenize_number
         = False)
    tangent_to_fasttext("tangent-source","fasttext-destination", tokenize_all=False, tokenize_number=True)

    :param tangent_tuple_filepath:
    :param fasttext_tuple_filepath:
    :param ignore_frp:
    :param tokenize_all:
    :param tokenize_number:
    """
...
def main():
    ...
    destination = '/home/bm3302/FastText/ft_opt_4/'
